...
class AddGear(bpy.types.Operator):
    ...
    ggm_change = BoolProperty(name = "Edit Selected",
                default = False,
                description = "Change Selected Gear")
    ...
    def execute(self, context):
        world_matr = Matrix.Translation(bpy.context.scene.cursor_location)
        rA = 0.0
        self.ggm_angCon = 0.0
        self.is_pair = False
